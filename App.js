            ...
            <div className="App">
                ...
                <Router>
                    <Switch>
                        ...
                        <AdminRoute exact path="/admin/dashboard/feedback" component={Feedback}/>
                        <AdminRoute exact path="/admin/dashboard/product" component={AllProduct}/>
                        <AdminRoute exact path="/admin/dashboard/verified" component={Verified}/>
                        <AdminRoute exact path="/admin/dashboard/notverified" component={NotVerified}/>
                        ...
                        <AdminRoute
                            exact
                            path="/admin/product/verifyproduct/:id"
