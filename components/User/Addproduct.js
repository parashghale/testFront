...
export default class Addproduct extends Component {
    ...
    validate = () => {
        ...
        if(!this.state.checkValidImage)
        {
            checkValidImage="Image is empty"
        }
        ...
        if (checkValidImage||productNameError || productPriceError || productDescriptionError || productConditionError || categoryError|| quantityError) {
            this.setState({checkValidImage,productNameError, productPriceError, productDescriptionError,productNameError,quantityError, productConditionError, categoryError})
            return false;
        }
        return true;
    }
            ...
            Axios
                ...
                .then((response) => {
                    ...
                    if (response.status == 200) {
                        ...
                        toast("New Product Added. Admin will verify after it will publicly displayed. ")
                    }
