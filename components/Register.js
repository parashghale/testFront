...
class Register extends Component {
    ...
    validate = () => {
        ...
        {
            checkValidImage="Image cannot be empty"
        }
        ...
        if (checkValidImage||nameError || address1Error || address2Error || address3Error || phoneError || mobilePhoneError || emailError || passwordError) {
            this.setState({
                checkValidImage,
                nameError,
                address1Error,
        ...
        return (
            <div className="product ">
                ...
                <Container>
                    ...
                    <Form className="rorm-part" onSubmit={this.handleSubmit}>
                        <Row>
                            <Col md="4" sm="6">
